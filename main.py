...
#acts as blueprint for creating clasmate objects
class Classmate:
...
#this is our array of classmate objects
classmates_list = [
    Classmate("Ebtisam", "10-RUBY", "ICT"),
    Classmate("Aeiou", "10-RUBY", "PE"),
    Classmate("Ethan", "10-RUBY", "TLE")
]
#this function updates the class list when the user adds a new name
...
#this function triggers when you press the "add button"
...
#triggers when you press "update graph"
